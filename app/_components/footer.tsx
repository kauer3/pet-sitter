  ...
  return (
    <footer className="flex flex-col items-center justify-center pt-20 pb-20 gap-12">
      <div className="flex flex-col gap-6 mx-5 max-w-2xs sm:max-w-2xl md:max-w-3xl lg:max-w-5xl text-center">
        <p className="text-lg text-text-900 leading-relaxed italic grow-2">
          I'm always happy to hear from you! Whether you have questions about my services, want to discuss your pet's needs, or just want to say hello, feel free to reach out. You can contact me via email at <a href="mailto:julia505@gmail.com" className="text-primary-700 hover:underline">julia505@gmail.com</a> or connect with me on social media. I look forward to hearing from you!
</p>
